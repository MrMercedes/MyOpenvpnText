...
public abstract class OpenVpnActivity extends AppCompatActivity implements VpnStatus.StateListener {

    private String TAG = OpenVpnActivity.class.getSimpleName();
